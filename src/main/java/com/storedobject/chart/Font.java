...
public class Font {
	...
	public Font(final Family family, final Size size) {
		this(family, null, size);
	}

	public Font(final Family family, final Style style, final Size size) {
		setFamily(family);
		this.style = style;
		setSize(size);
	}
	 ...
	 *            Font-size.
	 */
	public void setLineHeight(final Size size) {
		lineHeight = size;
	}
	 ...
	 *            Font-family.
	 */
	public final void setFamily(final Family family) {
	...
	public static class Size {
		...
		private Size(final int size, final int type) {
			this.size = size;
			this.type = type;
		}

		private Size(final double size, final int type) {
			this((int) (size * 1000), type);
		}

		public static Size percentage(final double percentage) {
			return new Size(percentage, 1);
		}

		public static Size pixels(final double pixels) {
			return new Size(pixels, 2);
		}

		public static Size points(final double points) {
			return new Size(points, 3);
		}

		public static Size em(final double em) {
			return new Size(em, 4);
		}

		public static Size rem(final double rem) {
			return new Size(rem, 5);
		}

		public static Size number(final int number) {
	...
	public static class Family {
		...
		private Family(final String family, final int type) {
			this.family = family;
			this.type = type;
		}

		private Family(final int type) {
			this(null, type);
		}
		 ...
		 */
		public static Family create(final String familyName) {
		 ...
		 *
		 * @param fallbackFamily
		 *            Fallback family to add.
		 */
		public void addFallback(final Family fallbackFamily) {
			if (fallback == null) {
		...
		private String plus(final String s) {
			if (fallback == null) {
				return s;
			}
			return s + "," + fallback;
	...
	public static class Stretch {
		...
		private Stretch(final int value) {
			this.value = value;
		}

		private Stretch(final double value) {
			this((int) (value * 1000));
		}
		 ...
		 *
		 * @param percentageToStretch
		 *            Percentage to stretch.
		 * @return Stretch created.
		 */
		public static Stretch create(final double percentageToStretch) {
