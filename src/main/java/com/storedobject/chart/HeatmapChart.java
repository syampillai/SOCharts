...
/**
 * Heatmap chart. A {@link VisualMap} is automatically created unless you set it explicitly to <code>null</code> via
...
public class HeatmapChart extends Chart {
    ...
    private class HD implements AbstractDataProvider<Object>, InternalDataProvider {
