...
/**
 * Shape class that can be added to {@link SOChart}. Positioning of the {@link Shape} on the screen is relative to its
 * parent. The parent could be an instance of the {@link SOChart} if this was added to that instance directly, or it
 * could be a {@link ShapeGroup} class if this was added to a {@link ShapeGroup} instance. Positioning can be done by
...
public abstract class Shape extends AbstractPart implements Component, HasPosition {
	 ...
	 *            Value to be encoded.
	 */
	protected static void encode(final StringBuilder sb, final String name, Object value) {
		if (value == null) {
			return;
		}
	 ...
	 *            Encoded JSON string to be appended to this.
	 * @param nameX
	 *            Name to be encoded for X value.
	 * @param nameY
	 *            Name to be encoded for Y value.
	 * @param point
	 *            Point to be encoded.
	 */
	protected static void encodePoint(final StringBuilder sb, final String nameX, final String nameY,
			final Point point) {
		if (point == null) {
			return;
		}
	 ...
	 *            Point to be encoded.
	 */
	protected static void encodePoint(final StringBuilder sb, final Point point) {
		if (point == null) {
			return;
		}
		encode(sb, "x", point.x);
	 ...
	 *            Encoded JSON string to be appended to this.
	 */
	protected void encodeShape(final StringBuilder sb) {
	}
	 ...
	 * <p>
	 * Note: If X and Y positions are set this way, other position details set through {@link #getPosition(boolean)}
	 * and/or {@link #setPosition(Position)} are ignored.
	 * </p>
	 *
	 * @param positionXY
	 *            XY position in pixels.
	 */
	public void setPosition(final Point positionXY) {
	 ...
	 */
	public void setPosition(final Number positionX, final Number positionY) {
		positionXY = new Point(positionX, positionY);
	}
	 ...
	 *
	 * @param create
	 *            Whether to create it now or not.
	 * @return Style.
	 */
	public final Style getStyle(final boolean create) {
	...
	public static class Style implements ComponentProperty {
		 ...
		 *            Fill color.
		 */
		public void setFillColor(final AbstractColor fillColor) {
		 ...
		 *            Stroke color.
		 */
		public void setStrokeColor(final AbstractColor strokeColor) {
		 ...
		 *            Line width.
		 */
		public void setLineWidth(final Number lineWidth) {
